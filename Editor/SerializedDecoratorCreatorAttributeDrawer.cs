...
namespace Foolish.Stats.ScriptableObjectDecorators.Editor
{
    using Foolish.Stats.Editor;
    
    [CustomPropertyDrawer(typeof(SerializedDecoratorCreatorAttribute))]
    public class SerializedDecoratorCreatorAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            var selectorAttribute = (SerializedDecoratorCreatorAttribute)attribute;
            var paramType = selectorAttribute.PropertyType;
            Type targetInterface = typeof(IStatDecoratorCreateOptions<>)
                .MakeGenericType(paramType);
                
            var derivedTypes = TypesCache.GetDerivedTypes(targetInterface)
